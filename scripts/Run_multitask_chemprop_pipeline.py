...
def run_pipeline(train = True, predict = True, analyze = True, train_base = True, train_morgan = True, train_rdkit = True, train_morgan_plus_rdkit = True,
	...
	layer_list = ([1]*10+[2]*10+[3]*10+[4]*10+[5]*10), lr_ratio = 1,
	...
	if analyze:
		...
		if not in_vivo_test_path is None:
			...
			evaluate_multiple_models([mod + '.csv' for mod in models_to_analyze], in_vivo_test_path, preds_dir, cutoff_type = 'in_vivo', include_classification_analysis = False, activity_name = activity_name)
			preds_dir = base_model_dir + '/tuned_in_vivo_predictions/'
			evaluate_multiple_models([mod + '.csv' for mod in models_to_analyze], in_vivo_test_path, preds_dir, cutoff_type = 'in_vivo', include_classification_analysis = False, activity_name = activity_name)

cvals_to_run = [0]
base_fpath = '/Users/jacobwitten/Documents/Next_steps/Anderson/ML for NP design/Chemprop/chemprop-master/Data/Luke_bioactive_screen/'
split_type = 'Random'
for i in cvals_to_run:
	prefix = base_fpath + split_type + '_split/fold_'+str(i) + '/'
	run_pipeline(base_model_save_dir = 'Luke_bioactive_screen_results', train_base = True, train_morgan = True, train_rdkit = False, train_morgan_plus_rdkit = False,
		train = False, predict = False, analyze = True,
		test_path = prefix + 'test_full.csv',
		train_path = prefix + 'train_full.csv',
		val_path = prefix + 'val_full.csv',
		split_name = split_type + '_split/fold_'+str(i) , save_smiles_splits = False, use_formulations = False)
# cvals_to_run = [0]
# base_fpath = '/Users/jacobwitten/Documents/Next_steps/Anderson/ML for NP design/Chemprop/chemprop-master/Data/Luke_bioactive_screen/'
# split_type = 'Scaffold'
# for i in cvals_to_run:
# 	prefix = base_fpath + split_type + '_split/fold_'+str(i) + '/'
# 	run_pipeline(base_model_save_dir = 'Luke_bioactive_screen_results', train_base = True, train_morgan = False, train_rdkit = False, train_morgan_plus_rdkit = False,
# 		train = True, predict = True, analyze = True,
# 		test_path = prefix + 'test_full.csv',
# 		train_path = prefix + 'train_full.csv',
# 		val_path = prefix + 'val_full.csv',
# 		split_name = split_type + '_split/fold_'+str(i) , save_smiles_splits = False, use_formulations = False)
...
# cvals_to_run = [0,1]
# base_fpath = '/Users/jacobwitten/Documents/Next_steps/Anderson/LNP data/Raj lipid screen/All_screen_data_combined/ML_formatted_data/A549_screen_for_ML/'
# split_type = 'predict_idris'
# for i in cvals_to_run:
# 	prefix = base_fpath + split_type + '_split/cv_'+str(i) + '/'
# 	run_pipeline(base_model_save_dir = 'A549_LNP_screen', train_base = True, train_morgan = True, train_rdkit = False, train_morgan_plus_rdkit = False,
# 		train = True, predict = True, analyze = True,
# 		test_path = prefix + 'test.csv',
# 		train_path = prefix + 'train.csv',
# 		val_path = prefix + 'validate.csv',
# 		split_name = split_type + '_split/cv_'+str(i) , save_smiles_splits = False, use_formulations = True)
...
# run_pipeline(base_model_save_dir = 'A549_LNP_screen', train_base = False, train_morgan = True, train_rdkit = False, train_morgan_plus_rdkit = False,
# 	train = False, predict = True, analyze = True,
# 	test_path = '/Users/jacobwitten/Documents/Next_steps/Anderson/LNP data/Raj lipid screen/All_screen_data_combined/ML_formatted_data/A549_screen_for_ML/random_split/test.csv',
# 	train_path = '/Users/jacobwitten/Documents/Next_steps/Anderson/LNP data/Raj lipid screen/All_screen_data_combined/ML_formatted_data/A549_screen_for_ML/random_split/train.csv',
# 	val_path = '/Users/jacobwitten/Documents/Next_steps/Anderson/LNP data/Raj lipid screen/All_screen_data_combined/ML_formatted_data/A549_screen_for_ML/random_split/validate.csv',
# 	split_name = 'Random_split', save_smiles_splits = False, use_formulations = True)
...
# run_pipeline(base_model_save_dir = 'Whitehead_results', train_base = True, train_morgan = True, train_rdkit = False, train_morgan_plus_rdkit = False, train = False, predict = False, analyze = True,
...
# print('running')
# run_pipeline(base_model_save_dir = 'Cancer_results', train_base = True, train_morgan = True, train_rdkit = True, train_morgan_plus_rdkit = True, train = False, predict = False, analyze = True,
...
# 	activity_name = 'NLOGGI50', xlabel='Predicted Anticancer Activity', ylabel='Experimental Anticancer Activity')

# run_pipeline(base_model_save_dir = 'MERS_results', train_base = True, train_morgan = True, train_rdkit = True, train_morgan_plus_rdkit = True, train = True, predict = True, analyze = True,
# 	test_path = 'Data/MERS_splits/test_full.csv', train_path = 'Data/MERS_splits/train_full.csv',
# 	val_path = 'Data/MERS_splits/val_full.csv', split_name = 'Scaffold_split', save_smiles_splits = False, use_formulations = False,
# 	activity_name = 'Inh_index', xlabel='Predicted anti-MERS Activity', ylabel='Experimental anti-MERS Activity')


# run_pipeline(base_model_save_dir = 'Heiser_nCoV_results', train_base = True, train_morgan = True, train_rdkit = True, train_morgan_plus_rdkit = True, train = False, predict = True, analyze = True,
# 	test_path = 'Data/Heiser_nCoV_splits/test_full.csv', train_path = 'Data/Heiser_nCoV_splits/train_full.csv',
# 	val_path = 'Data/Heiser_nCoV_splits/val_full.csv', split_name = 'Scaffold_split', save_smiles_splits = False, use_formulations = False,
# 	activity_name = 'hit_score', xlabel='Predicted anti-SARS CoV 2 Activity', ylabel='Experimental anti-SARS CoV 2 Activity')
