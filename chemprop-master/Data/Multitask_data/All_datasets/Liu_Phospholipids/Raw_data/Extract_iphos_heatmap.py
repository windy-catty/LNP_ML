...
color_to_lum_dict = {}
color_to_lum_dict[255,203,139,255] = 0
color_to_lum_dict[243,105,33,255] = 1
...
x_start = 87
x_end = 810
y_starts = [55,177,244,399,465,520,574,]
...
for i in range(len(values_high)):
	all_vals = all_vals + get_matrix_data([x_start,y_starts[i]], x_end-x_start, y_ends[i]-y_starts[i], 39,values_high[i])
