...
color_to_lum_dict = {}
color_to_lum_dict[250,233,219,255] = 0
color_to_lum_dict[246,214,184,255] = 1
color_to_lum_dict[212,113,45,255] = 2
color_to_lum_dict[141,75,28,255] = 3
...
submatrix_heights = [281-88, 468-286, 603-474, 880-621, 1120-886, 1281-1127, 1314-1288]
vert_origins = [88,286,474,621,886,1127,1288]
values_high = [6,7,5,10,9,6,1]


all_vals = []
for i in range(len(values_high))
	all_vals = all_vals + get_matrix_data([88,submatrix_heights[i]], submatrix_length, submatrix_heights[i], 13,values_high[i])
...
df.to_csv(header + '_screen_lum_values.csv')
