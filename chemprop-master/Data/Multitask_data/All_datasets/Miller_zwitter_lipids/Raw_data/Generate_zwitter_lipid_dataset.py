...
def generate_structures():
	...
	for t, tail in 	enumerate(tail_names):
		for a, amine in enumerate(amine_names):
			...
			zal_smiles = structure_from_components(asmiles, tsmiles)
			all_smiles.append(zal_smiles)
...
structures.to_csv('ZAL_structures.csv', index = False)
