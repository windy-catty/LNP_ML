...
image = Image.open('200_screen_image_new_scale.png')
pix = image.load()
# print(image.size)
# print(pix[64,64])
...
submatrix_length = 846-94
submatrix_height = 604-106



all_vals = get_matrix_data([96,108], submatrix_length, submatrix_height, 25,8)

# vals = get_matrix_data([51,51],submatrix_length, submatrix_height,12,4)
image.save('200_screen_image_with_dots.png',format = 'png')
# print(len(all_vals))
# print(len(all_vals[0]))
# print(all_vals)
# print(vals)
df = pd.DataFrame(all_vals)
df.to_csv('200_screen_lum_values.csv')
